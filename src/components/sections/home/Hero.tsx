        ...
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              Comprehensive testing platform for developers and QA teams. Monitor performance,
              validate functionality, and optimize user experience across all devices.
            </p>
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              ...
              >
                <Play className="mr-2 size-5" /> View Dashboard Demo
              </Button>
            </div>
          </div>
            ...
            <div className="relative overflow-hidden rounded-2xl border bg-card shadow-2xl">
              <div className="aspect-[16/10] relative">
                <Image
                  ...
                  alt="Test Site dashboard showing analytics and performance metrics"
                  fill
